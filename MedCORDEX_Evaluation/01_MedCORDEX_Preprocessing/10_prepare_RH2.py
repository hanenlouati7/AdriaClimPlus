...
for yr in yr_v:
    if int(yr) <= 2014:
        input_file = f"/data/inputs/METOCEAN/historical/model/atmos/ENEA/Med-CORDEX/historical/{yr}/RH2_{yr}.nc"
    else:
        input_file = f"/data/inputs/METOCEAN/historical/model/atmos/ENEA/Med-CORDEX/projections/SSP245/{yr}/RH2_{yr}.nc"
    if int(yr) == 2005:
         input_file = f"/work/cmcc/vr25423/Project/AdriaClimPlus/data/data_MEDCORDEX/downloaded_processed/2005/RH2_{yr}.nc"
    if int(yr) == 2006:
         input_file = f"/work/cmcc/vr25423/Project/AdriaClimPlus/data/data_MEDCORDEX/downloaded_processed/2006/RH2_{yr}.nc"
    output_file = f"../processed/MEDCORDEX_{yr}_RH2"
