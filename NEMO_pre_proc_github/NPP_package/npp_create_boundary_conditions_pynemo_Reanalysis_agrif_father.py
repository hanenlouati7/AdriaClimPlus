...
## Prepare PyBDY input namelis and run PyBDY
    if (tidei==1 and nn==0):
        os.system('cp inputs_pynemo/namelist_tide_03s_agrif_father.bdy inputs_pynemo/namelist_daily.bdy')
    else:
        os.system('cp inputs_pynemo/namelist_03s_agrif_father.bdy inputs_pynemo/namelist_daily.bdy')
