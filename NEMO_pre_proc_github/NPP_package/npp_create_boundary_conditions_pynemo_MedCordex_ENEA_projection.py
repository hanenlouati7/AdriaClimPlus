...
for bc_year in range(bc_yearini,bc_yearend+1):
    ifileT = bc_input_folder+py.str_(bc_year)+\
            '/THETA_'+py.str_(bc_year)+'_Daily.nc'
    ifileS = bc_input_folder+py.str_(bc_year)+\
            '/SALT_'+py.str_(bc_year)+'_Daily.nc'
    ifileU = bc_input_folder+py.str_(bc_year)+\
            '/UVEL_'+py.str_(bc_year)+'_Daily.nc'
    ifileV = bc_input_folder+py.str_(bc_year)+\
            '/VVEL_'+py.str_(bc_year)+'_Daily.nc'
    ifileE = bc_input_folder+py.str_(bc_year)+\
            '/ELEVATION_'+py.str_(bc_year)+'_Daily.nc'
######
    ifileTb = bc_input_folder+py.str_(bc_year-1)+\
            '/THETA_'+py.str_(bc_year-1)+'_Daily.nc'
    ifileSb = bc_input_folder+py.str_(bc_year-1)+\
            '/SALT_'+py.str_(bc_year-1)+'_Daily.nc'
    ifileUb = bc_input_folder+py.str_(bc_year-1)+\
            '/UVEL_'+py.str_(bc_year-1)+'_Daily.nc'
    ifileVb = bc_input_folder+py.str_(bc_year-1)+\
            '/VVEL_'+py.str_(bc_year-1)+'_Daily.nc'
    ifileEb = bc_input_folder+py.str_(bc_year-1)+\
            '/ELEVATION_'+py.str_(bc_year-1)+'_Daily.nc'
######
    ifileTa = bc_input_folder+py.str_(bc_year+1)+\
            '/THETA_'+py.str_(bc_year+1)+'_Daily.nc'
    ifileSa = bc_input_folder+py.str_(bc_year+1)+\
            '/SALT_'+py.str_(bc_year+1)+'_Daily.nc'
    ifileUa = bc_input_folder+py.str_(bc_year+1)+\
            '/UVEL_'+py.str_(bc_year+1)+'_Daily.nc'
    ifileVa = bc_input_folder+py.str_(bc_year+1)+\
            '/VVEL_'+py.str_(bc_year+1)+'_Daily.nc'
    ifileEa = bc_input_folder+py.str_(bc_year+1)+\
            '/ELEVATION_'+py.str_(bc_year+1)+'_Daily.nc'
######
    if(bc_year==2015):
        ifileTh = '/data/inputs/METOCEAN/historical/'+\
                  'model/ocean/ENEA/Med-CORDEX/historical/'+\
                  py.str_(bc_year-1)+'/THETA_'+\
                  py.str_(bc_year-1)+'_Daily.nc'
        ifileSh = '/data/inputs/METOCEAN/historical/'+\
                  'model/ocean/ENEA/Med-CORDEX/historical/'+\
                  py.str_(bc_year-1)+'/SALT_'+\
                  py.str_(bc_year-1)+'_Daily.nc'
        ifileUh = '/data/inputs/METOCEAN/historical/'+\
                  'model/ocean/ENEA/Med-CORDEX/historical/'+\
                  py.str_(bc_year-1)+'/UVEL_'+\
                  py.str_(bc_year-1)+'_Daily.nc'
        ifileVh = '/data/inputs/METOCEAN/historical/'+\
                  'model/ocean/ENEA/Med-CORDEX/historical/'+\
                  py.str_(bc_year-1)+'/VVEL_'+\
                  py.str_(bc_year-1)+'_Daily.nc'
        ifileEh = '/data/inputs/METOCEAN/historical/'+\
                  'model/ocean/ENEA/Med-CORDEX/historical/'+\
                  py.str_(bc_year-1)+'/ELEVATION_'+\
                  py.str_(bc_year-1)+'_Daily.nc'
######
    nct  = Dataset(ifileS)
...
#########
    ...
    for nn in range(0,nnend.days+1):
        ...
        os.system('rm -f '+bc_output_folder+'/lon.nc')
        os.system('rm -f '+bc_output_folder+'/lat.nc')
        os.system('rm -f inputs_pynemo/namelist_daily.bdy')

        print(' ')
        print('Year: ',name1r,' Month: ',name2r,' Day: ',name3r)

        if(dateb.year==2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileEh+' '+bc_output_folder+'/SSH.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileEh+' '+bc_output_folder+'/OUT_SSH.nc.end1 > \
                      /dev/null 2>&1')

        elif(dateb.year!=2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            if(dateb.year-1==2015): ttb=364
            if(dateb.year-1%4==0): ttb=366
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileEb+' '+bc_output_folder+'/SSH.nc.ini > \
                      /dev/null 2>&1')
            ...
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileE+' '+bc_output_folder+'/SSH.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
                  ' '+ifileE+' '+bc_output_folder+'/OUT_SSH.nc.end1 > \
                  /dev/null 2>&1')
#############
## CREATE LON AND LAT OF REFERENCE (FROM 2D TO 1D)
## TAKING TO THE MIDDLE OF ADRIATIC SEA
#############
        os.system('ncks -v lon -d iy,190 '+bc_output_folder+\
                  '/SSH.nc.ini '+bc_output_folder+'/lon1.nc')
        os.system('ncks -v lat -d jx,290 '+bc_output_folder+\
                  '/SSH.nc.ini '+bc_output_folder+'/lat1.nc')
        os.system('ncwa -a iy '+bc_output_folder+'/lon1.nc '+\
                  bc_output_folder+'/lon.nc')
        os.system('ncwa -a jx '+bc_output_folder+'/lat1.nc '+\
                  bc_output_folder+'/lat.nc')
        os.system('rm -f '+bc_output_folder+'/lon1.nc '+\
                  bc_output_folder+'/lat1.nc')
##############
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/SSH.nc.ini '+\
                  bc_output_folder+'/OUT_SSH.nc.ini')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_SSH.nc.ini')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_SSH.nc.ini')
        ...
        os.system('ncrcat -h '+bc_output_folder+'/OUT_SSH.nc.end1 '+\
                  ...
                  '/SSH.nc.end')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/SSH.nc.end '+\
                  bc_output_folder+'/OUT_SSH.nc.end')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_SSH.nc.end')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_SSH.nc.end')
        os.system('rm -f '+bc_output_folder+'/OUT_SSH.nc.end1 '+\
                  ...
                  bc_output_folder+'/SSH.nc.ini '+\
                  bc_output_folder+'/SSH.nc.end')
        #####
        if(dateb.year==2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileTh+' '+bc_output_folder+'/T.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileTh+' '+bc_output_folder+'/OUT_T.nc.end1 > \
                      /dev/null 2>&1')
        elif(dateb.year!=2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            if(dateb.year-1==2015): ttb=364
            if(dateb.year-1%4==0): ttb=366
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileTb+' '+' '+bc_output_folder+'/T.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
            ...
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileT+' '+' '+bc_output_folder+'/T.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
                      ' '+ifileT+' '+bc_output_folder+'/OUT_T.nc.end1 > \
                      /dev/null 2>&1')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/T.nc.ini '+\
                  bc_output_folder+'/OUT_T.nc.ini')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_T.nc.ini')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_T.nc.ini')
        ...
        os.system('ncrcat -h '+bc_output_folder+'/OUT_T.nc.end1 '+\
                  ...
                  '/T.nc.end')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/T.nc.end '+\
                  bc_output_folder+'/OUT_T.nc.end')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_T.nc.end')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_T.nc.end')
        os.system('rm -f '+bc_output_folder+'/OUT_T.nc.end1 '+\
                  ...
                  bc_output_folder+'/T.nc.ini '+\
                  bc_output_folder+'/T.nc.end')
        #####
        if(dateb.year==2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileSh+' '+bc_output_folder+'/S.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileSh+' '+bc_output_folder+'/OUT_S.nc.end1 > \
                      /dev/null 2>&1')
            ...
            if(dateb.year-1%4==0): ttb=366
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileSb+' '+' '+bc_output_folder+'/S.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
            ...
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileS+' '+' '+bc_output_folder+'/S.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
                      ' '+ifileS+' '+bc_output_folder+'/OUT_S.nc.end1 > \
                      /dev/null 2>&1')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/S.nc.ini '+\
                  bc_output_folder+'/OUT_S.nc.ini')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_S.nc.ini')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_S.nc.ini')
        ...
        os.system('ncrcat -h '+bc_output_folder+'/OUT_S.nc.end1 '+\
                  ...
                  '/S.nc.end')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/S.nc.end '+\
                  bc_output_folder+'/OUT_S.nc.end')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_S.nc.end')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_S.nc.end')
        os.system('rm -f '+bc_output_folder+'/OUT_S.nc.end1 '+\
                  ...
                  bc_output_folder+'/S.nc.ini '+\
                  bc_output_folder+'/S.nc.end')
        #####
        if(dateb.year==2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileUh+' '+bc_output_folder+'/VELU.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileUh+' '+bc_output_folder+'/OUT_VELU.nc.end1 > \
                      /dev/null 2>&1')
        elif(dateb.year!=2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            if(dateb.year-1==2015): ttb=364
            if(dateb.year-1%4==0): ttb=366
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileUb+' '+' '+bc_output_folder+'/VELU.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
            ...
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileU+' '+' '+bc_output_folder+'/VELU.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
                      ' '+ifileU+' '+' '+bc_output_folder+'/OUT_VELU.nc.end1 > \
                      /dev/null 2>&1')

        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/VELU.nc.ini '+\
                  bc_output_folder+'/OUT_VELU.nc.ini')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_VELU.nc.ini')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_VELU.nc.ini')
        ...
        os.system('ncrcat -h '+bc_output_folder+'/OUT_VELU.nc.end1 '+\
                  ...
                  '/VELU.nc.end')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/VELU.nc.end '+\
                  bc_output_folder+'/OUT_VELU.nc.end')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_VELU.nc.end')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_VELU.nc.end')
        os.system('rm -f '+bc_output_folder+'/OUT_VELU.nc.end1 '+\
                  ...
                  bc_output_folder+'/VELU.nc.ini '+\
                  bc_output_folder+'/VELU.nc.end')
        #####
        if(dateb.year==2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileVh+' '+bc_output_folder+'/VELV.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileVh+' '+bc_output_folder+'/OUT_VELV.nc.end1 > \
                      /dev/null 2>&1')
        elif(dateb.year!=2015 and dateb.month==1 and dateb.day==1):
            ttb=365
            if(dateb.year-1==2015): ttb=364
            if(dateb.year-1%4==0): ttb=366
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileVb+' '+' '+bc_output_folder+'/VELV.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
            ...
            os.system('cdo -w seltimestep,'+py.str_(ttb)+'/'+py.str_(ttb)+\
                      ' '+ifileV+' '+' '+bc_output_folder+'/VELV.nc.ini > \
                      /dev/null 2>&1')
            os.system('cdo -w seltimestep,'+py.str_(ttr)+'/'+py.str_(ttr)+\
                      ' '+ifileV+' '+' '+bc_output_folder+'/OUT_VELV.nc.end1 > \
                      /dev/null 2>&1')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/VELV.nc.ini '+\
                  bc_output_folder+'/OUT_VELV.nc.ini')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_VELV.nc.ini')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_VELV.nc.ini')
        ...
        os.system('ncrcat -h '+bc_output_folder+'/OUT_VELV.nc.end1 '+\
                  ...
                  '/VELV.nc.end')
        os.system('ncks -C -O -x -v lon,lat '+bc_output_folder+'/VELV.nc.end '+\
                  bc_output_folder+'/OUT_VELV.nc.end')
        os.system('ncks -A -v lon '+bc_output_folder+'/lon.nc '+\
                  bc_output_folder+'/OUT_VELV.nc.end')
        os.system('ncks -A -v lat '+bc_output_folder+'/lat.nc '+\
                  bc_output_folder+'/OUT_VELV.nc.end')
        os.system('rm -f '+bc_output_folder+'/OUT_VELV.nc.end1 '+\
                  ...
                  bc_output_folder+'/VELV.nc.ini '+\
                  bc_output_folder+'/VELV.nc.end')
