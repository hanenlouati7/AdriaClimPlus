...
!  grid information 
!------------------------------------------------------------------------------
   sn_src_hgr = '/work/cmcc/vs15521/NEMO_pre_proc/Reanalysis/mesh_hgr.nc'
   sn_src_zgr = '/work/cmcc/vs15521/NEMO_pre_proc/Reanalysis/mesh_zgr.nc'
   ...
   sn_src_msk = '/work/cmcc/vs15521/NEMO_pre_proc/Reanalysis/mask.nc'
   sn_bathy   = '/work/cmcc/vs15521/NEMO_pre_proc/NEMO_input_files/depth_ADRb.020_03s_notime_agrif_father.nc'

!------------------------------------------------------------------------------
!  I/O 
!------------------------------------------------------------------------------
   sn_src_dir = '/work/cmcc/vs15521/NEMO_pre_proc/NPP_package/inputs_pynemo/src_data_reanalysis_agrif_father.ncml'
   sn_dst_dir = '/work/cmcc/vs15521/NEMO_pre_proc/NPP_package/bc_outputs_reanalysis_agrif'
...
!------------------------------------------------------------------------------
    ...
    sn_tide_grid   = '/work/cmcc/gv29119/OTPS_highres/OTPSnc/DATA_MED/gridMed.nc'
    sn_tide_h      = '/work/cmcc/gv29119/OTPS_highres/OTPSnc/DATA_MED/hf.Med2011.nc'
    sn_tide_u      = '/work/cmcc/gv29119/OTPS_highres/OTPSnc/DATA_MED/uv.Med2011.nc'
