...
date_init = datetime(year = 1990, month = 1, day = 1, hour = 0)		#for comparison with WRF stand-alone exp (2019)
#date_end = datetime(year = 2020, month = 1, day = 1, hour = 18)
date_end = datetime(year = 2020, month = 12, day = 31, hour = 18)
...
while date_init <= date_end:
	...
	# for WRF estimations
	dato = Dataset("/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/WRF-WRF-Hydro/1990_2020/run/EXP/wrfout_d01_"+date_init.strftime("%Y-%m-%d")+"_00:00:00", 'r')    # 50mm FST 
...
df.to_csv(path_or_buf = "./Rainfall_1990_2020_WRF_WRF-HYDRO_EVALUATION_30_YEARS.csv", index = True)
