...
for yr in yr_v:
    if int(yr) <= 2014:
        input_file = f"/data/inputs/METOCEAN/historical/model/atmos/ENEA/Med-CORDEX/historical/{yr}/PSFC_{yr}.nc"
    else:
        input_file = f"/data/inputs/METOCEAN/historical/model/atmos/ENEA/Med-CORDEX/projections/SSP585/{yr}/PSFC_{yr}.nc"
    if int(yr) == 2005:
         input_file = f"/work/cmcc/vr25423/Project/AdriaClimPlus/data/data_MEDCORDEX/downloaded_processed/2005/PSFC_{yr}.nc"
    if int(yr) == 2006:
         input_file = f"/work/cmcc/vr25423/Project/AdriaClimPlus/data/data_MEDCORDEX/downloaded_processed/2006/PSFC_{yr}.nc"
    output_file = f"../processed/MEDCORDEX_{yr}_PSFC"
