...
##bathyo_filename = '/work/cmcc/vs15521/NEMO_pre_proc/NEMO_input_files/depth_ADRb.020_03s_agrif_venice.nc'
##bathyo_filename = '/work/cmcc/resm-dev/vladimir/FLAME/EXPS/test_AGRIF/domain_cfg.nc'
##bathyo_filename = '/work/cmcc/vs15521/NEMO_pre_proc/NEMO_input_files/domain_cfg_agrif_father.nc'
###################################################################
...
ic_output_folder='./ic_outputs_agrif'
## Name to new interpolated NEMO TS initial file
ic_output_filename = 'IC_Agrif_father_Reanalysis_20191225.nc'
## Defines Temp. and Sal. Initial input files (CMEMS Reanalysis)
tempi_filename='/data/inputs/METOCEAN/historical/model/ocean/CMS/MedSea/CMCC/reanalysis/day/2019/12/20191225_d-CMCC--TEMP-MFSe3r1-MED-b20200901_re-sv01.00.nc'
sali_filename='/data/inputs/METOCEAN/historical/model/ocean/CMS/MedSea/CMCC/reanalysis/day/2019/12/20191225_d-CMCC--PSAL-MFSe3r1-MED-b20200901_re-sv01.00.nc'
######################################################################
######################################################################
## Define inputs to create NEMO Boundary Conditions
bc_year=2020         # define year to create files
...
bc_output_folder='./bc_outputs_reanalysis_agrif'
