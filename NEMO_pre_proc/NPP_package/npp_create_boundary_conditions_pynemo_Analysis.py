...
import os
#################################
datei = datetime.datetime(bc_year, bc_monthini, 8)
bc_dayend=31
...
datee = datetime.datetime(bc_year, bc_monthend, 12)#bc_dayend)
#########
nnend=datee-datei
for nn in range(0,nnend.days+1):
    ...
    bc_input_ssh+' '+bc_output_folder+'/OUT_SSH.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_SSH.nc '+bc_output_folder+'/OUT_SSH.nc.ini')
    os.system('rm -f '+bc_output_folder+'/OUT_SSH.nc')
    os.system('cp '+bc_input_folder+'/'+name1r+'/'+name2r+'/'+name1r+name2r+name3r+\
    bc_input_ssh+' '+bc_output_folder+'/OUT_SSH.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_SSH.nc '+bc_output_folder+'/OUT_SSH.nc.end1')
    os.system('rm -f '+bc_output_folder+'/OUT_SSH.nc')
    os.system('cp '+bc_input_folder+'/'+name1a+'/'+name2a+'/'+name1a+name2a+name3a+\
    bc_input_ssh+' '+bc_output_folder+'/OUT_SSH.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_SSH.nc '+bc_output_folder+'/OUT_SSH.nc.end2')
    os.system('rm -f '+bc_output_folder+'/OUT_SSH.nc')
    ...
    os.system('cp '+bc_input_folder+'/'+name1b+'/'+name2b+'/'+name1b+name2b+name3b+\
    bc_input_temp+' '+bc_output_folder+'/OUT_T.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_T.nc '+bc_output_folder+'/OUT_T.nc.ini')
    os.system('rm -f '+bc_output_folder+'/OUT_T.nc')
    os.system('cp '+bc_input_folder+'/'+name1r+'/'+name2r+'/'+name1r+name2r+name3r+\
    bc_input_temp+' '+bc_output_folder+'/OUT_T.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_T.nc '+bc_output_folder+'/OUT_T.nc.end1')
    os.system('rm -f '+bc_output_folder+'/OUT_T.nc')
    os.system('cp '+bc_input_folder+'/'+name1a+'/'+name2a+'/'+name1a+name2a+name3a+\
    bc_input_temp+' '+bc_output_folder+'/OUT_T.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_T.nc '+bc_output_folder+'/OUT_T.nc.end2')
    os.system('rm -f '+bc_output_folder+'/OUT_T.nc')
    ...
    os.system('cp '+bc_input_folder+'/'+name1b+'/'+name2b+'/'+name1b+name2b+name3b+\
    bc_input_sal+' '+bc_output_folder+'/OUT_S.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_S.nc '+bc_output_folder+'/OUT_S.nc.ini')
    os.system('rm -f '+bc_output_folder+'/OUT_S.nc')
    os.system('cp '+bc_input_folder+'/'+name1r+'/'+name2r+'/'+name1r+name2r+name3r+\
    bc_input_sal+' '+bc_output_folder+'/OUT_S.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_S.nc '+bc_output_folder+'/OUT_S.nc.end1')
    os.system('rm -f '+bc_output_folder+'/OUT_S.nc')
    os.system('cp '+bc_input_folder+'/'+name1a+'/'+name2a+'/'+name1a+name2a+name3a+\
    bc_input_sal+' '+bc_output_folder+'/OUT_S.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_S.nc '+bc_output_folder+'/OUT_S.nc.end2')
    os.system('rm -f '+bc_output_folder+'/OUT_S.nc')
    ...
    os.system('cp '+bc_input_folder+'/'+name1b+'/'+name2b+'/'+name1b+name2b+name3b+\
    bc_input_vel+' '+bc_output_folder+'/OUT_VEL.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_VEL.nc '+bc_output_folder+'/OUT_VEL.nc.ini')
    os.system('rm -f '+bc_output_folder+'/OUT_VEL.nc')
    os.system('cp '+bc_input_folder+'/'+name1r+'/'+name2r+'/'+name1r+name2r+name3r+\
    bc_input_vel+' '+bc_output_folder+'/OUT_VEL.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_VEL.nc '+bc_output_folder+'/OUT_VEL.nc.end1')
    os.system('rm -f '+bc_output_folder+'/OUT_VEL.nc')
    os.system('cp '+bc_input_folder+'/'+name1a+'/'+name2a+'/'+name1a+name2a+name3a+\
    bc_input_vel+' '+bc_output_folder+'/OUT_VEL.nc')
    os.system('ncks -d lon,-6.0,-36.3 '+bc_output_folder+'/OUT_VEL.nc '+bc_output_folder+'/OUT_VEL.nc.end2')
    os.system('rm -f '+bc_output_folder+'/OUT_VEL.nc')
...
## Prepare PyBDY input namelis and run PyBDY
    if (tidei==1 and nn==0):
        os.system('cp inputs_pynemo/namelist_tide.bdy inputs_pynemo/namelist_daily.bdy')
    else:
        os.system('cp inputs_pynemo/namelist.bdy inputs_pynemo/namelist_daily.bdy')
