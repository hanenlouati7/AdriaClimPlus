...
dato = Dataset("/work/cmcc/ad07521/FLAME/WRF_WRF_HYDRO_validation/BACINI/DATA_ERA5LAND_PRECIP/rain_ERA5Land_1990-2020_basins_on_wrf_grid.nc", 'r')
...
date_init = datetime(year = 1990, month = 1, day = 1, hour = 0)
...
for i in range(0,45292):
#for i in range(0,1):

        #print ('Slice of time: ' +str(i))	
	# ones: return a new array of given shape and type, filled with ones 
#	pioggia = -9999*np.ones((181, 193))
...
df.to_csv(path_or_buf = "./Rainfall_1990_2020_ERA5_Land_basins_on_wrf_grid.csv", index = True)
