...
bathyiv_filename = '/work/opa/vs15521/NEMO_pre_proc/Venice_Lagoon_bathymetry/restcoast_bathy_final.nc'
...
lonoi= 12.03385    ## 11.99999905 ## 12.03385    ## min. longitude (West limit)
lonoe= 13.94020    ##13.89583302 ## 13.94020    ## max. longitude (East limit)
latoi= 42.95052    ##42.93750000 ## 42.95052    ## min. latitude  (South limit)
latoe= 45.86198    ##45.81260000 ## 45.86198    ## max. latitude  (North limit)
...
bathyo_filename = '../NEMO_input_files/depth_ADRb.020_03s_agrif_venice.nc'
if(agrif==1):
