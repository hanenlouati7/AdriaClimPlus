...
process_path_t2m = "/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/pp/ERA5/files_t2m"
process_path_prec = "/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/pp/ERA5/files_tp"
process_path_vn = "/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/pp/ERA5/files_wind"
process_path_RH2 = "/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/pp/ERA5/files_RH2"
process_path_SLP = "/work/cmcc/vr25423/Project/AdriaClimPlus/evaluation_run_30yrs_ERA5/pp/ERA5/files_SLP/processed"
...
for i in range(0,4):
    files = []
    for yr in range(start_yr,end_yr+1):
        input_file_SLP = f"{process_path_SLP}/SLP_wrfout_d01_{yr}_{seasons[i-1]}.nc"
        output_file_SLP = f"{process_path_SLP}/SLP_wrfout_d01_{start_yr}_{end_yr}_{seasons[i-1]}.nc"
